    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2023, 12, 16, 17, 19, 27, 722594))),
            ],
        ),
        migrations.CreateModel(
            name='Rounds',
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app5.users')),
            ],
        ),
        migrations.CreateModel(
            name='Joined',
