# Generated by Django 4.0 on 2024-01-04 03:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app1', '0003_person_age_person_email'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_orders', models.ManyToManyField(to='app1.PurchaseOrder')),
                ('sales_orders', models.ManyToManyField(to='app1.SalesOrder')),
            ],
        ),
        migrations.CreateModel(
            name='OpeningStock',
