"""
Django settings for api_arms project.
...
SECRET_KEY = 'django-insecure-lwx$-k97&epw=#!oo=t8r3h(6rv7pbk2-_9qv#0al9a(x-nhh8'
...
WSGI_APPLICATION = 'api_arms.wsgi.application'
