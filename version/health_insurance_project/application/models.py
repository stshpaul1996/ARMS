...
class Common_fields(models.Model):
    created_by=models.ForeignKey(MyUser, related_name="%(class)s_created_by",on_delete=models.CASCADE,null=True)
    created_at=models.DateTimeField(auto_now_add=True,null=True)
    updated_by=models.ForeignKey(MyUser, related_name="%(class)s_updated_by",on_delete=models.CASCADE,null=True)
