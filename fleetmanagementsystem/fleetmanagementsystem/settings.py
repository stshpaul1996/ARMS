"""
Django settings for fleetmanagementsystem project.
...
SECRET_KEY = "django-insecure-%9!u_0p(!_&klgm1bn@_-_yd9x_@c(s5p@su17$#y2($)jnebe"
...
WSGI_APPLICATION = "fleetmanagementsystem.wsgi.application"
